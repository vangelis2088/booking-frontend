              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form @submit.prevent="login" role="form">
                    <div class="mb-3">
                      <argon-input v-model="username" type="text" placeholder="Username" name="username" size="lg" />
                    </div>
                    <div class="mb-3">
...
//import setAuthHeader from "@/common/api.service";
...
export default {
  ...
  methods: {
    async login(e) {
      ...
      axios
        .post("http://127.0.0.1:8000/api/rest-auth/login/", credentials)
        .then((response) => {
